...
type CopyCmd struct {
	*base.Base
	Src  dbs.BlocksDBID `ask:"<source>" help:"The source, the DB to copy. Must exist."`
	Dest dbs.BlocksDBID `ask:"<dest>" help:"The destination, the name of the copy. Must not exist yet."`
}
